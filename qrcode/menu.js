...
var alcoholChecks = ["Vodka", "Rum", "Tequila", "Mezcal", "Gin", "Brandy", "Sake"];
var whiskeyChecks = ["Whiskey", "Rye", "Scotch", "Bourbon", "Local", "Rare", "Canadian", "Irish", "Japanese"];
var funChecks = ["I'm Feeling Lucky"];
var filterChecks = [];
filterChecks.push(...foodChecks, ...flavorChecks, ...alcoholChecks, ...funChecks, ...whiskeyChecks);
