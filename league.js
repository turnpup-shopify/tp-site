  ...
  function works() {
      ...
      var url = "";
      if (stat == "points") {
        url = "https://infinite-hollows-2352.herokuapp.com/scrapePoints";
      } else if (stat == "assists") {
        url = "https://infinite-hollows-2352.herokuapp.com/scrapeAssists";
      } else if (stat == "rebounds") {
        url = "https://infinite-hollows-2352.herokuapp.com/scrapeRebounds";
      } else if (stat == "steals") {
        url = "https://infinite-hollows-2352.herokuapp.com/scrapeSteals";
      }
