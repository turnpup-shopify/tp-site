  ...
  function works() {
      ...
      document.getElementById("change").innerHTML = "2016-2017 NBA League Leaders in " + value;
      ...
      var url = "";
      url="http://playoffscurry.herokuapp.com/nbaleaders";
      var url2 = "http://playoffscurry.herokuapp.com/nbaleadersassists";
      var url3 = "http://playoffscurry.herokuapp.com/nbaleadersrebounds";
      var url4 = "http://playoffscurry.herokuapp.com/nbaleaderssteals";
      var use = "";
      if (stat == "assists") {
        use=url2;
