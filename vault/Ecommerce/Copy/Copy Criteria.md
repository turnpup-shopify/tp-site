...
* Should be specific when possible over vague. 
* Should serve one of the following purposes
	* Can you falsify it? it shouldn't be debate-able
	* Can any word

## Tagline Copy (could be incorporated into headers for bonus  points)

A+ Criteria
* Defy the norms: do something surprising that most brands in the category don't do it. (e.g. Oura Ring did campaign tag line "Give us the finger.")
* Two Meanings: If the copy can be read two ways thats a plus with both ways being a positive meanings for the product
* Spicy: Can you name who'd flinch? If nobody would, there's no edge. Test: would this need a defense in a stakeholder meeting? If it sailed through, it's inert.